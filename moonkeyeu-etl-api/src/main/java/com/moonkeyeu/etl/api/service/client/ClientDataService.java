...
public class ClientDataService {
    ...
    @Autowired
    public ClientDataService(WebClient webClient, ThrottleService throttleService, @Qualifier("objectMapper") ObjectMapper objectMapper) {
    ...
    private Mono<JsonNode> fetchNextPage(URI url, List<JsonNode> allResults) {
        return webClient.get()
                ...
                .retryWhen(Retry.backoff(5, Duration.ofSeconds(2))
                        ...
                        .filter(throwable -> throwable instanceof RateLimitExceededException))
                .doOnSubscribe(subscription -> {
