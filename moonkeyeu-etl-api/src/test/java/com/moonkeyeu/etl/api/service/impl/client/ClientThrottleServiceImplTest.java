...
class ClientThrottleServiceImplTest {
    @Mock
    ...
    void setUp() {
        ...
        throttleService = new ClientThrottleServiceImpl(webClientBuilder, "http://test-url");
    ...
    void fetchThrottle_shouldFetchThrottle_whenCurrentUseReachLimit() {
        ...
        when(responseSpec.bodyToMono(ThrottleResponse.class))
                .thenReturn(Mono.just(responseUseSeconds));

        Mono<ThrottleResponse> result = throttleService.fetchThrottle();
